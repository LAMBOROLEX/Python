...
def add_file():
    files = filedialog.askopenfilenames(title = "Select Image",
                                        ...
                                        initialdir = "C:\\Users\\visio\\OneDrive\\Desktop\\python\\GUI\\Image")
    for file in files:
...
def browse_dest_path() :
    folder_selected = filedialog.askdirectory(initialdir="C:\\Users\\visio\\OneDrive\\Desktop\\python\\GUI\\Image")
    if folder_selected == "" :
        return
...
opt_width = ["Original", "1024px", "800px", "640px"]
cmb_width = ttk.Combobox(frame_option, state = "readonly", value = opt_width, width = 10)
cmb_width.current(0)
...
cmb_format = ttk.Combobox(frame_option, state = "readonly", value = opt_format, width = 10)
...
cmb_space = ttk.Combobox(frame_option, state = "readonly", value = opt_width, width = 10)
cmb_space.current(0)
